...
const CreateCardPage: FC = () => {
    ...
    const [organizations, setOrganizations] = useState<Array<Organization["id"]>>([]);
    // const [boards, setBoards] = useState<Array<Option<Board["id"]>>>([]);
    const [boards, setBoards] = useState<Array<Board["id"]>>([]);
    // const [lists, setLists] = useState<Array<Option<List["id"]>>>([]);
    const [lists, setLists] = useState<Array<List["id"]>>([]);
    // const [labels, setLabels] = useState<Array<Option<LabelType["id"]>>>([]);
    const [labels, setLabels] = useState<Array<LabelType["id"]>>([]);
